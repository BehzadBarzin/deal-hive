...
export function Banner({
  ...
  return (
    <>
      ...
      <div className={`${prefix}dealhive-container ${prefix}dealhive-override`}>
        <span
          className={`${prefix}dealhive-message ${prefix}dealhive-override`}
        ...
        {!canRemoveBranding && (
          <a
            className={`${prefix}dealhive-branding`}
            href={`${env.NEXT_PUBLIC_SERVER_URL}`}
          >
            Powered by Deal Hive
          </a>
        )}
      </div>
    </>
